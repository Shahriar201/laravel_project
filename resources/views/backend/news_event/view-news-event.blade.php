                        ...
                        <div class="card-header">
                            <h3>News and Event List
                                <a class="btn btn-success float-right btn-sm" href="{{ route('news_events.add') }}">
                                    <i class="fa fa-plus-circle"></i>Add News and Event</a>
                            ...
                            <table id="example1" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a title="Edit" id="edit" class="btn btn-sm btn-primary" href="{{ route('news_events.edit', $news->id)}}">
                                                <i class="fa fa-edit"></i>
                                            </a>

                                            <a title="Delete" id="delete" class="btn btn-sm btn-danger" href="{{ route('news_events.delete', $news->id) }}">
