                        ...
                        <form method="post" action="{{ route('missions.update', $editData->id) }}" id="myForm" enctype="multipart/form-data">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <textarea name="title" class="form-control" rows="6">{{ $editData->title }}</textarea>
                                </div>
                               ...
                               <div class="form-group col-md-2">
                                    <img id="showImage" src="{{ (!empty($editData->image))?url('public/upload/mission_images/'.$editData->image):url('public/upload/no_image.jpg') }}"
