                        ...
                        <div class="card-header">
                            <h3>Mission List
                                ...
                                <a class="btn btn-success float-right btn-sm" href="{{ route('missions.add') }}">
                                    <i class="fa fa-plus-circle"></i>Add Mission</a>
                            ...
                            <table id="example1" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a title="Edit" id="edit" class="btn btn-sm btn-primary" href="{{ route('missions.edit', $mission->id)}}">
                                                <i class="fa fa-edit">

                                                </i>
                                            </a>
                                            <a title="Delete" id="delete" class="btn btn-sm btn-danger" href="{{ route('missions.delete', $mission->id) }}">
                                                <i class="fa fa-trash">
